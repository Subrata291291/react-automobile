  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://script.google.com/macros/s/AKfycby-lU2iK6c8AHDd4YuJmAzNGuM9Uy3Y7tDOTDbzomgVjYKytecHJCdwGAT3zu4uNtz6/exec",
        {
          method: "POST",
  ...
  return (
    <section className="form-area">
      <div className="container">
        <div className="form-box" data-aos="fade-right" data-aos-delay="200">
